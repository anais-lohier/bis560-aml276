...
This section provides summary statistics for each ethnicity group, including means, standard deviations, and group counts for both temperature measures. These values characterize the distribution of the analytic variables prior to inferential testing.
```{r}
# compute mean/SD for both temp variables within each ethnicity category
descriptive_stats <- analytic_subset |>
  group_by(Ethnicity) |>
  summarise(
